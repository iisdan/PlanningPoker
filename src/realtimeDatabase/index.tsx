...
function factory($provider: 'firestore' | 'realtimedb') {
  switch($provider) {
     ...
     */
    case 'firestore':
      return new FirestoreProvider(config.firebase);
     ...
     */
    case 'realtimedb':
      return new FirebaseRealtimeDBProvider(config.firebase);

  }
}

export const realtimeDatabase: DataProvider = factory(config.dataProvider);
